...
def cheapest_move(program, valgrind, valgrind_check, colours):
	...
	# Reference output
	stdout_ref_moves = "ra\nra\npb\nra\npb\nra\nra\nra\npb\npb\nra\npb\npb\npb\npb\nra\nsa\n"
	stdout_ref_cheapest = "[0,0]\n"
	stdout_ref = stdout_ref_moves + stdout_ref_cheapest
